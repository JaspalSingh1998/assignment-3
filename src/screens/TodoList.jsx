  ...
  return (
    <div className='mt-10 shadow-md shadow-gray-300 p-8 rounded-md'>
        ...
        <form className='flex justify-center mb-10'>
            <input type="text" placeholder="Enter Todo" className="text-xl text-orange-800 placeholder-orange-400 py-2 px-5 bg-orange-100 rounded-l-full outline-orange-300" value={task} onChange={(e) => setTask(e.target.value)}/>
            <button type="submit" className="text-xl text-orange-100 placeholder-orange-400 py-2 pr-5 pl-4 bg-orange-500 rounded-r-full" onClick={handleSubmit}>
        ...
        <div className="max-h-80 overflow-y-auto">
                <table id="todo_table" className="table w-full">
                    ...
                    {list && list.map(( item, index ) => {
                            return (
                                <tr className=" bg-orange-50 transition duration-300" key={index}>
                                    ...
                                    <td className="text-center  px-1 py-2 text-orange-800 flex gap-3 justify-center">
                                        <button className="text-orange-600" onClick={() => handleDelete(item.id)}>
